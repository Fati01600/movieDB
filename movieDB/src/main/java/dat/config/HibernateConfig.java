...
import org.hibernate.cfg.Configuration; // Korrekt import for Hibernate Configuration
...
public class HibernateConfig {
    ...
    public static EntityManagerFactory getEntityManagerFactoryForTest() {
        if (emfTest == null)
            emfTest = createEMF(true, ""); // Ingen db nødvendigt for test
        return emfTest;
    }

    // TODO: Vigtigt: Tilføj entity-klasser her, så de registreres hos Hibernate
    ...
    private static EntityManagerFactory createEMF(boolean forTest, String dbName) {
        try {
            ...
            // Sæt de grundlæggende egenskaber
